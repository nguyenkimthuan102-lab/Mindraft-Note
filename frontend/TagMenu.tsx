...
const styles = StyleSheet.create({
  container: {
    backgroundColor: '#fff', borderRadius: 8, width: 220, paddingVertical: 8, elevation: 5,
  ...
  createBtn: {
    flexDirection: 'row', alignItems: 'center', padding: 10, borderTopWidth: 1, borderTopColor: '#eee', gap: 10,
    ...Platform.select({ web: { cursor: 'pointer' } as any })
  },

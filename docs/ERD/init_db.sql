...
CREATE TABLE notifications (
    id          CHAR(36)                                                    NOT NULL,
    user_id     CHAR(36)                                                    NOT NULL,
    type        ENUM('reminder_triggered','collaboration_invited','collaborator_removed') NOT NULL,
    ...
    CONSTRAINT fk_notif_user
        FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
    CONSTRAINT fk_notif_note
        FOREIGN KEY (note_id) REFERENCES notes(id) ON DELETE SET NULL
) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;


-- 14. Bảng RESET_TOKENS (mới hoàn toàn)
-- Lưu token tạm thời sau khi verify OTP reset_password thành công
-- Single-use, hết hạn 15 phút
...
-- 15. Bảng xác thực otp

CREATE TABLE otp_verifications (
    id          CHAR(36)        NOT NULL,
    email       VARCHAR(255)    NOT NULL,       -- lưu email thay vì user_id vì user chưa tồn tại
    otp_hash    VARCHAR(512)    NOT NULL,       -- hash của OTP, không lưu plaintext
